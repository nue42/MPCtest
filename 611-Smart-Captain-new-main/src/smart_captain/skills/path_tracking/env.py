...
from smart_captain.skills.path_tracking.config import MPC_CONFIG, PATH_TRACKING_SPEC
from scipy.interpolate import interp1d, CubicSpline
import numpy as np

class PathTrackingEnv(BaseEnvironment,SkillAdapter):
    spec = PATH_TRACKING_SPEC
